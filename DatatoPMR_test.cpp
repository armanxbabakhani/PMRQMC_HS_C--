...
bool PartDiag_compare(vector<ParticleDiag> DiagA , vector<ParticleDiag> DiagB){
    vector<ParticleDiag> DiagB2 = DiagB;
    bool DiagAiMatched;
...
int main(int argc , char* argv[]){
    ...
    vector<vector<int>> A4 = {{4 , 2 , 1 , 0 , 1},{0 , 2 , 3 , 1 , 3}};
    //vector<vector<int>> A4 = {{2 , 0 , 2},{2 , 2 , 0}};
    int mod4 = 4 , mod2=2 , mod3 = 3;

    cout << endl;
    cout << "The mod 2 nullspace is: " << endl;
    // printMatrix( Nullspace_n(A4 ,   mod2) );
    vector<vector<int>> Atry = Modp_nullspace(A4 , 5);
    cout << "Atry size is: " << Atry.size() << endl;
    printMatrix( Atry );
    ...
    if(n21.size() > 0){
        ...
        Simplify_nullspace(M21 , n21 , mod2);
        printMatrix(n21);
    }
    else{
    ...
    vector<TotalDiag> DChain1 = {D1,D2,D1}, DChain2 = {D3, D2, D1} , DChain3 = {D2 , D1, D1} , DChain4 = {D2 , D1} , DChain5 = {D1, D4, D2, D3};
    vector<vector<TotalDiag>> DCplus1 = {DChain1 , DChain2 , DChain4} , DCplus2 = {DChain3 , DChain5 };
    complex<double> c1(1.0 , -1.5) , c2(-1.0 , 1.5) , c3(-2.5 , 1.0) , c4(3.0,0.0);
    vector<complex<double>> CCplus1 = {c1 , c3 , c4} , CCplus2 = {c2 , c3};

    cout << "Testing Diag append:" << endl;
    cout << endl;
    cout << "Before addition: " << endl;
    cout << "DCplus1 is " << endl;
    Print_diagonals(DCplus1 , CCplus1);
    cout << endl; 
    Print_diagonals(DCplus2 , CCplus2);
    cout << endl;
    cout << "After addition: " << endl;
    Diag_append(DCplus1 , CCplus1 , DCplus2 , CCplus2);
    Print_diagonals(DCplus1 , CCplus1);*/

    // Testing the cancelation
    return 0;
}
